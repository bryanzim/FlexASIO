...
configure_file("${CMAKE_CURRENT_LIST_DIR}/installer-clang.in.iss" "${CMAKE_CURRENT_LIST_DIR}/out/installer-clang.iss" @ONLY)
include(execute_process_or_die)
execute_process_or_die(
    COMMAND "${InnoSetup_iscc_EXECUTABLE}" out/installer-clang.iss /Oout/installer /FFlexASIO-clang-${FLEXASIO_VERSION}
)
